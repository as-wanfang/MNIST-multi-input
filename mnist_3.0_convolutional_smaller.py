...
datavis.animate(training_step, 151, train_data_update_freq=1, test_data_update_freq=10)
...
# 200 epoches, train_size =  3000
# best 0.9438

# 150 epoches, train_size =  600
# best 0.8603, train accuracy becomes 1 after 50 epoches
